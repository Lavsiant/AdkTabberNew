...
namespace DbRepository
{
    public class DataContext : IdentityDbContext<User>
    {
        ...
        public DbSet<GuitarIteration> GuitarIterations { get; set; }

        public DbSet<PianoIteration> PianoIterations { get; set; }

        public DbSet<DrumIteration> DrumIterations { get; set; }
